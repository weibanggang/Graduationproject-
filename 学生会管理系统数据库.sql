...
('123456','123456','正常','账号密码都为123456'),
('456789','456789','正常','账号密码都为456789'),
('123321','123321','正常','账号密码都为123321'),
('11111','11111','冻结中','账号密码都为11111'),
('22222','22222','冻结中','账号密码都为22222');
#3部门类型
...
('s1s143','张婷','15348564582','冻结中'),
('s2s143','张婷','15348564582','冻结中'),
('s3s143','张婷','15348564582','冻结中'),
('s1s147','王莹','15348564855','使用中'),
('s2s147','王莹','15348564855','使用中'),
('s3s147','王莹','15348564855','使用中'),
('s1s150','易微','15348564588','使用中');
#6会议类型
...
('第十五届学生会','备注15届学生会','使用中',1),
('第十四届学生会','备注14届学生会','使用中',2),
('第十三届学生会','备注13届学生会','使用中',3),
('第十二届学生会','备注12届学生会','使用中',4);
#9成员信息
...
('100010001','123456','小邦哥','男',1,'18776203778',1,4,'',2,1,'761273133','可用中','2018-01-01','2018-10-10',''),
('100010002','123456','廖珠炫','男',1,'18776235778',3,3,'',2,1,'861273133','可用中','2018-01-01','2018-10-10',''),
('100010003','123456','朱茂深','男',1,'18776553778',3,4,'',2,2,'361273133','可用中','2018-01-01','2018-10-10',''),
('100010004','123456','彭金华','男',1,'18346203778',2,3,'',2,3,'111273133','可用中','2018-01-01','2018-10-10',''),
('100010005','123456','钟世杨','男',1,'19976203778',1,4,'',2,1,'761173133','可用中','2018-01-01','2018-10-10',''),
('100010006','123456','邹雅','女',1,'18766203778',1,2,'',2,1,'721271133','可用中','2018-01-01','2018-10-10',''),
('100010007','123456','廖月康','男',1,'11276203778',1,4,'',2,1,'711173133','可用中','2018-01-01','2018-10-10','');
#10工作安排
...
insert into WorkArrangement(w_title,w_contents,d_id,m_id,w_date)values
('文体部工作安排','关于写策划内容',3,2,'2018-10-11'),
('纪检部部工作安排','关于检查内容',6,2,'2018-10-11'),
('秘书部工作安排','关于进行秘书内容',2,2,'2018-10-11'),
('播音部工作安排','关于放音乐内容',4,2,'2018-10-11'),
('宣传部工作安排','关于写宣传内容',5,2,'2018-10-11');
#11公告
create table Notic(
...
insert into Notic(n_title,n_context,n_file,m_id,status)values
('关于国庆放假通知','放假内容','目前无路径',5,'显示中'),
('关于元旦放假通知','放假内容','目前无路径',2,'显示中'),
('关于五一放假通知','放假内容','目前无路径',5,'显示中'),
('关于学生会活动通知','活动内容','目前无路径',1,'显示中');
#12请假记录
